...
<form class="form-horizontal" style="background-color: #4e3f3e;width: 50%;margin:auto;color: white;" name="artForm" action="home.html" method="post" onSubmit ="      validateEntries()">
  ...
  <div class="form-group">
   <label class="control-label col-sm-3" for="copyrightno">Copyright Registration Number:</label>
      <div class="col-sm-8">
 ...
 <div class="form-group">
   <label class="control-label col-sm-3" for="region">Region of origin:</label>
      <div class="col-sm-8">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
   <label class="control-label col-sm-3" for="about">About you:</label>
      <div class="col-sm-8">
 ...
 <div class="form-group">
   <label class="control-label col-sm-3" for="aob">Any other thing for fans:</label>
      <div class="col-sm-8">
   ...
   <div style="float: right; color: black;"><input type="submit" name="Sign up" onclick="validate()"></div><br>
   <br>
