...
<form class="form-horizontal" style="background-color: #4e3f3e;width: 50%;margin:auto;color: white;" name="artForm" action="home.html" method="post" onSubmit ="validateEntries()">
  ...
  <div class="form-group">
    <label class="control-label col-sm-3" for="id">Id:</label>
      <div class="col-lg-8">
        <input type="text" class="form-control" name= "id" placeholder="Employee id" required autofocus pattern="[0-9]+" title="Only letters">
      </div>
  </div> 
 ...
 <div class="form-group">
  ...
  <!-- Submission section for form -->
   <div style="float: right; color: black;"><input type="submit" name="submit" onclick="validate()"></div><br>
   <br>
