  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"><nav>
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="../pages/home.php"> About </a></li>
      </ul></nav>
    </div> <!-- /.navbar-collapse -->
	</div>
...
<form name="myForm" style = "background-color: #4e3f3e;  width :50%; margin: auto" action="" onsubmit="return validateForm()" method="post">
