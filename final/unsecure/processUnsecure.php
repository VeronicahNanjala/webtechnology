...
*@author veronicah Nanjala, Lesapiti, tito
  ...
  $verlogin= new databaseConnection;
    ...
    if ($result){
        ...
        if(password_verify($password, $hash)==$pass){
            ...
            header("location: ../layout/employeePage.php");
...
function verifylogin($username,$password){
    ...
    if ($result){
        ...
        if(password_verify($password, $hash)==$pass){
            ...
            header("location: ../layout/listenerlayout.php");
...
function verifyloginArtist($username,$password){
    ...
    $sql="SELECT user_name, password FROM  artists WHERE user_name= '$username' ";
    ...
    if ($result){
        ...
        if(password_verify($password, $hash)==$pass){
            ...
            header("location: ../layout/songpage.php");
...
function regartist($fn,$ln,$email,$uname,$pwd,$mtype,$contact){
    ...
    $executeqry=$register->sqlInjection($sql,$fn,$ln,$uname,$email,$pwd,$mtype,$contact);
